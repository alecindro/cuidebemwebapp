var EventoRotina = /** @class */ (function () {
    function EventoRotina() {
        this.sinaisvitais = [
            {
        ...
        this.eventos = [{ descricao: "Sinais Vitais", rotinas: this.sinaisvitais, icon: "heart" },
    ...
    EventoRotina.prototype.getDescricaoEvento = function () {
        return this.eventos.map(this.mapDescricao);
    };
    EventoRotina.prototype.getIcon = function (descricao) {
        var pos = this.eventos.map(function (_eventos) { return _eventos.descricao; }).indexOf(descricao);
        return this.eventos[pos].icon;
    };
    EventoRotina.prototype.getRotinas = function (descricao) {
        var pos = this.eventos.map(function (_eventos) { return _eventos.descricao; }).indexOf(descricao);
        return this.eventos[pos].rotinas;
    };
    EventoRotina.prototype.mapDescricao = function (element) {
        return element.descricao;
    };
    EventoRotina.prototype.filterDescricaoEvento = function (element, index, array) {
        return (element);
    };
    return EventoRotina;
}());
export { EventoRotina };
//# sourceMappingURL=eventorotina.js.map