...
var UsuarioService = /** @class */ (function () {
    ...
    UsuarioService.prototype.get = function (login) {
    ...
    UsuarioService.prototype.getUsuario = function (login) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.get(login).toPromise()];
                    case 1:
                        res = _a.sent();
                        usuario = res.body;
    ...
    UsuarioService.prototype.changePassowrd = function (passwordChange) {
        return this.api.post("sec/account/change-password", passwordChange);
    };
    UsuarioService.prototype.getUserDTO = function (login) {
        return this.api.get("sec/users/" + login);
    };
    UsuarioService.prototype.desactiveUserDTO = function (login) {
        return this.api.post("sec/users/desactive", login);
    };
    UsuarioService.prototype.updateUserDTO = function (userDTO) {
        return this.api.put("sec/users/", userDTO);
    };
    UsuarioService.prototype.createUserDTO = function (userDTO) {
